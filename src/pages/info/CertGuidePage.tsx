...
const CERT_DATA: Record<'ko' | 'en', Record<CertTab, CertContent>> = {
  ...
  axis: {
    ...
    levels: [
      { level: 'L3 (Starter)', target: 'AI 입문자·대학생', questions: '객관식 40 + 실습 8', time: '90분', passing: '60점 이상' },
      { level: 'L2 (Practitioner)', target: '실무 2년 이상', questions: '사례형 객관식 30 + 실습 3과제', time: '120분', passing: '60점 이상' },
      { level: 'L1 (Leader)', target: '리더·아키텍트', questions: '객관식 25 + 실행계획서 + 서술형 2', time: '150분', passing: '60점 이상' },
    ],
    levelsFootnote: '※ 합격은 총점 60점 이상이며 영역별 최저기준(객관식·실습형)을 모두 충족해야 합니다. 경계 점수는 전문가 검수를 거쳐 확정됩니다.',
    scope: [
  ...
  'axis-c': {
    ...
    levels: [
      { level: 'L3 (Starter)', target: '자동화에 입문하는 현업 실무자', questions: '객관식 40 + 실습 8', time: '90분', passing: '60점 이상' },
      { level: 'L2 (Practitioner)', target: '업무 자동화를 구현하는 실무자', questions: '사례형 객관식 30 + 실습 3과제', time: '120분', passing: '60점 이상' },
      { level: 'L1 (Leader)', target: '자동화 운영·거버넌스 담당자', questions: '객관식 25 + 실행계획서 + 서술형 2', time: '150분', passing: '60점 이상' },
    ],
    levelsFootnote: '※ 합격은 총점 60점 이상, 실습형 최소기준 미달 시 별도 검토.',
    scope: [
  ...
  'axis-h': {
    ...
    levels: [
      { level: 'L3 (Starter)', target: '비임상 실무 입문자', questions: '객관식 40 + 실습 8', time: '90분', passing: '60점 이상' },
      { level: 'L2 (Practitioner)', target: '비임상 실무자', questions: '사례형 객관식 30 + 실습 3과제', time: '120분', passing: '60점 이상' },
      { level: 'L1 (Leader)', target: '의료기관 AI 도입 리더', questions: '객관식 25 + 실행계획서 + 서술형 2', time: '150분', passing: '60점 이상' },
    ],
    scope: [
  ...
  axis: {
    ...
    levels: [
      { level: 'L3 (Starter)', target: 'AI beginners & university students', questions: '40 MCQ + 8 practical', time: '90 min', passing: '60 or above' },
      { level: 'L2 (Practitioner)', target: '2+ years of work experience', questions: '30 case-based MCQ + 3 practical tasks', time: '120 min', passing: '60 or above' },
      { level: 'L1 (Leader)', target: 'Leaders & architects', questions: '25 MCQ + action plan + 2 essays', time: '150 min', passing: '60 or above' },
    ],
    levelsFootnote: '※ Passing requires a total score of 60 or above; practical work below the minimum standard is reviewed separately.',
    scope: [
  ...
  'axis-c': {
    ...
    levels: [
      { level: 'L3 (Starter)', target: 'Practitioners new to automation', questions: '40 MCQ + 8 practical', time: '90 min', passing: '60 or above' },
      { level: 'L2 (Practitioner)', target: 'Practitioners building work automation', questions: '30 case-based MCQ + 3 practical tasks', time: '120 min', passing: '60 or above' },
      { level: 'L1 (Leader)', target: 'Automation operations & governance leads', questions: '25 MCQ + action plan + 2 essays', time: '150 min', passing: '60 or above' },
    ],
    levelsFootnote: '※ Passing requires a total score of 60 or above; practical work below the minimum standard is reviewed separately.',
    scope: [
  ...
  'axis-h': {
    ...
    levels: [
      { level: 'L3 (Starter)', target: 'Newcomers to non-clinical work', questions: '40 MCQ + 8 practical', time: '90 min', passing: '60 or above' },
      { level: 'L2 (Practitioner)', target: 'Non-clinical practitioners', questions: '30 case-based MCQ + 3 practical tasks', time: '120 min', passing: '60 or above' },
      { level: 'L1 (Leader)', target: 'Leaders driving AI adoption in healthcare', questions: '25 MCQ + action plan + 2 essays', time: '150 min', passing: '60 or above' },
    ],
    scope: [
